...
while (1 == 1):
    ...
    top = Tk(screenName="test")
    C = Canvas(top, bg="grey", height=(hight * zoom), width=(width * zoom), cursor="circle")
    for y2 in range(0, hight):
        for x2 in range(0, width):
            ...
            # oval = C.create_oval(x, y, x + 10, y + 10)
            oval = C.create_polygon(x, y, x + zoom, y, x + zoom, y + zoom, x, y + zoom, fill=filly, activefill="white")
    ...
    # givves opptions
    bs = input(
        "0:exit menu 1:place house(£5000 and 1 log) 2:place shop(£5000) 3:place road(£1000) 4:plant tree(£50) 5:remove + 2 log per tree(£2000) 7:Brige(£1000 and 2 logs) 8:windmill small(£2000 and 2 logs) 9:windmill large(£10000 and 5 logs) 10:Build reserch staition(£10000 and 4 logs) 11:skip movement 12:save | Enter your choice:")
    if not (bs == "11"):
        if (bs == "1"):
            if cur == (" "):
                # TODO: write code...
